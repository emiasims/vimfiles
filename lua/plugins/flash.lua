...
return {
  ...
  config = function(_, flash_opts)
    ...
    map('n', 's', function() sneak({ forward = true }) end)
    map('n', 'S', function() sneak({ forward = false }) end)
    map('n', ';', function() repeat_jump({ forward = true }) end)
    map('n', ',', function() repeat_jump({ forward = false }) end)
